...
@Table(name = "\"PetCareCenter\"", schema =  "\"bedemo\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"bedemo\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"bedemo\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"bedemo\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"bedemo\"")
